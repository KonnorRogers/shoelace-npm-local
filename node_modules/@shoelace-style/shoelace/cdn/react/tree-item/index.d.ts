...
declare class SlComponent extends React.Component<Parameters<typeof component>[0]> {
    ...
    render(): React.FunctionComponentElement<Partial<{
        ...
        onSlExpand: (e: SlExpandEvent) => void;
        onSlAfterExpand: (e: SlAfterExpandEvent) => void;
        onSlCollapse: (e: SlCollapseEvent) => void;
        onSlAfterCollapse: (e: SlAfterCollapseEvent) => void;
        onSlLazyChange: (e: SlLazyChangeEvent) => void;
        onSlLazyLoad: (e: SlLazyLoadEvent) => void;
