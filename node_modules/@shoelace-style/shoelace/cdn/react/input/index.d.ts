...
declare class SlComponent extends React.Component<Parameters<typeof component>[0]> {
    ...
    render(): React.FunctionComponentElement<Partial<{
        ...
        type: "number" | "search" | "time" | "text" | "date" | "datetime-local" | "email" | "password" | "tel" | "url";
        value: string;
        name: string;
        firstUpdated: () => void;
        ...
        autocorrect: "off" | "on";
        autocomplete: string;
        enterkeyhint: "search" | "previous" | "next" | "enter" | "done" | "go" | "send";
        ...
        setRangeText: (replacement: string, start?: number | undefined, end?: number | undefined, selectMode?: "select" | "start" | "end" | "preserve" | undefined) => void;
        showPicker: () => void;
        stepUp: () => void;
        stepDown: () => void;
    } & {
