...
declare class SlComponent extends React.Component<Parameters<typeof component>[0]> {
    ...
    render(): React.FunctionComponentElement<Partial<{
        ...
        anchor: string | Element | import("../../components/popup/popup.component.js").VirtualElement;
        ...
        skidding: number;
        arrow: boolean;
        arrowPlacement: "center" | "anchor" | "start" | "end";
        arrowPadding: number;
        flip: boolean;
