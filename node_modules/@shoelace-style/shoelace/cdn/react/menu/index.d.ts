...
declare class SlComponent extends React.Component<Parameters<typeof component>[0]> {
    ...
    render(): React.FunctionComponentElement<Partial<{
        ...
        getAllItems: () => import("../../shoelace.js").SlMenuItem[];
        getCurrentItem: () => import("../../shoelace.js").SlMenuItem | undefined;
        setCurrentItem: (item: import("../../shoelace.js").SlMenuItem) => void;
    } & {
        onSlSelect: (e: SlSelectEvent) => void;
