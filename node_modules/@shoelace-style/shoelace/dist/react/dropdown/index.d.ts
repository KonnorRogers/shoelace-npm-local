...
declare class SlComponent extends React.Component<Parameters<typeof component>[0]> {
    ...
    render(): React.FunctionComponentElement<Partial<{
        ...
        show: () => Promise<void>;
        hide: () => Promise<void>;
        popup: import("../../shoelace.js").SlPopup;
        placement: "left" | "top" | "top-start" | "top-end" | "bottom" | "bottom-start" | "bottom-end" | "right" | "right-start" | "right-end" | "left-start" | "left-end";
        distance: number;
        skidding: number;
        ...
        hoist: boolean;
        focusOnTrigger: () => void;
        getMenu: () => import("../../shoelace.js").SlMenu | undefined;
        ...
        onSlShow: (e: SlShowEvent) => void;
        onSlAfterShow: (e: SlAfterShowEvent) => void;
        onSlHide: (e: SlHideEvent) => void;
        onSlAfterHide: (e: SlAfterHideEvent) => void;
